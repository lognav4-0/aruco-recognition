...
target_aruco_id = int(input("qual o id do aruco que voce deseja gerar?"))


target_aruco = None
for data in input_json:
    if data["id"] == target_aruco_id:
        target_aruco = data
        break
...
if target_aruco is None:
    ...
    <model name='aruco_marker_{target_aruco_id}'>
        ...
        <visual name='front_visual_{target_aruco_id}'>
            ...
            <material>
            <script>
                <uri>model://arucos/materials/scripts/aruco_marker_{target_aruco_id}.material</uri>
                <uri>model://arucos/materials/textures/{target_aruco_id}.png</uri>
                <name>Marker{target_aruco_id}</name>
            </script>
            </material>
        </visual>
    ...
    material_template = f"""material Marker{target_aruco_id}\n{{\n    technique\n    {{\n        pass\n        {{\n            texture_unit\n            {{\n                texture ../textures/{target_aruco_id}.png\n            }}\n        }}\n    }}\n}}"""

    material_file_path = os.path.join(caminho_arucos_material, f'aruco_marker_{target_aruco_id}.material')
